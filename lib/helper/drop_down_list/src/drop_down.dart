...
class MainBody<T> extends StatefulWidget {
  ...
  @override
  State<MainBody<T>> createState() => MainBodyState<T>();
}

class MainBodyState<T> extends State<MainBody<T>> {
  ...
  void updateMainList(List<SelectedListItem<T>> newList) {
    print('Update Main List');
    setState(() {
      mainList = newList;
    });
  }
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      if (widget.dropDown.enableAdd)
                        ElevatedButton(
                          onPressed: widget.dropDown.onAddButtonPressed,
                          child: widget.dropDown.addButtonChild ??
                              Text(widget.dropDown.addButtonText),
                        ),
